...
Download and install [cURL](http://curl.haxx.se/download.html) 32bit-SSL so that
CURL/lib and CURL/include are in your Program Files directory, and copy all .dll files from CURL/dlls to the top level directory where craft.exe is located.
